...
class UserManagerTests: XCTestCase {
    ...
    func testClipperFlow() {
        let card = ClipperCard(number: 1_111_111_111, cashValue: 5.00, passes: [])
    ...
    func testTicketFlow() {
        ...
        let ticket3 = Ticket(name: "Monthly Pass", duration: DateInterval(start: Date().addingTimeInterval(3600), duration: 2_592_000), price: 260.0, validOnAgency: .CalTrain)
