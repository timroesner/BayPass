...
class GoogleMapsTests: XCTestCase {
    ...
    func testRouteParser() {
        ...
        XCTAssertEqual(testRoute?.departureTime, Date(timeIntervalSince1970: 1539632611))
        XCTAssertEqual(testRoute?.arrivalTime, Date(timeIntervalSince1970: 1539636989))
